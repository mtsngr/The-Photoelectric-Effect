...
//       CYAN   
  ...
  float x[ndata] = {0.050, 0.100, 0.150, 0.200, 0.250, 0.300, 0.350};
  float y[ndata] = {0.22, 0.18, 0.12, 0.10, 0.06, 0.04, 0.00, 0.00};
  float sx[ndata]= {0.001, 0.001, 0.001, 0.001, 0.001, 0.001, 0.001};
  float sy[ndata]= {0.02, 0.02, 0.02, 0.02, 0.02, 0.02, 0.02};
