...
//       Vs - Frequency  
  ...
  float x[ndata] = {5.19, 5.49, 6.08, 6.88};
  float y[ndata] = {0.377, 0.323, -3.37, 0.550};
  float sx[ndata]= {0.00, 0.00, 0.00, 0.00};
  float sy[ndata]={4.45, 7.33, 0.109, 2.03};
  ...
  */
  ...
  mygraph->SetTitle("; Frequency 10^{14} Hz; Vs (V)");
